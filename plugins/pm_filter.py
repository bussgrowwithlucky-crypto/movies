...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if has_free_trial:
            await query.answer(" ʏᴏᴜ'ᴠᴇ ᴀʟʀᴇᴀᴅʏ ᴄʟᴀɪᴍᴇᴅ ʏᴏᴜʀ ꜰʀᴇᴇ ᴛʀɪᴀʟ ᴏɴᴄᴇ !", show_alert=True)
            return
        else:            
    ...
    elif query.data in ("seeplans", "free", "broze", "other"):
        await query.answer("🎬 ɴᴏ ᴘʀᴇᴍɪᴜᴍ ɴᴇᴇᴅᴇᴅ! ᴊᴜꜱᴛ ᴠᴇʀɪꜰʏ ᴏɴᴄᴇ ᴀɴᴅ ᴇɴᴊᴏʏ ᴀʟʟ ᴍᴏᴠɪᴇꜱ ꜰᴏʀ ꜰʀᴇᴇ.", show_alert=True)
...
async def auto_filter(client, msg, spoll=False , pm_mode = False):
    ...
    if imdb:
        ...
        cap = f"<b>Hey {user_name},\n\n<i>Found Results For Your Query</i>\nQuery : <code>{search}</code></b>"
